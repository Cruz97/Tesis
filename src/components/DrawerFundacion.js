    ...
    return (
     ...
     <Text style={style.name}>
       ...
       <Drawer.Section title="Menu">
         ...
         <Item label="Publicaciones" icon="publish" selected={routeName === 'MascotasF'} onPress={() => { this.setState({ active: 'MascotasF' }); this.props.navigation.navigate('MascotasF') }}/>
         <Item label="Solicitudes" icon="pets" selected={routeName === 'SolicitudesF'} onPress={() => { this.setState({ active: 'SolicitudesF' }); this.props.navigation.navigate('SolicitudesF') }}/>
         ...
         <Item label="Reportes" icon="pie-chart" selected={routeName === 'Reports'} onPress={() => { this.setState({ active: 'Reports' }); this.props.navigation.navigate('Reports')}}/>
         <Item label="Acerca de" icon="report" selected={routeName === 'About'} onPress={() => { this.setState({ active: 'About' }); this.props.navigation.navigate('About')}}/>
         <Item label="Cerrar Sesión"  icon = "exit"  onPress={() => { this.setState({ active: 'Tools' }); this.signOut()}}/>
    </Drawer.Section>
